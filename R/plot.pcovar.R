...
# euclid
     ...
     points(o.pcovar$euclidpca[,1],o.pcovar$euclidpca[,2]*rev[1],pch=16,cex=0.3)
     points(o.pcovar$euclidpco[,1],o.pcovar$euclidpco[,2]*rev[1],pch=1,cex=0.8)
...
# manhattan
     ...
     points(o.pcovar$manhpca[,1],o.pcovar$manhpca[,2]*rev[2],pch=16,cex=0.3)
     points(o.pcovar$manhpco[,1],o.pcovar$manhpco[,2]*rev[2],pch=1,cex=0.8)
     abline(h=0,v=0,lwd=0.6,col="gray")
...
# chord
     ...
     points(o.pcovar$cordpca[,1],o.pcovar$cordpca[,2]*rev[3],pch=16,cex=0.3)
     points(o.pcovar$cordpco[,1],o.pcovar$cordpco[,2]*rev[3],pch=1,cex=0.8)
     abline(h=0,v=0,lwd=0.6,col="gray")
...
# canberra
     ...
     points(o.pcovar$canpca[,1],o.pcovar$canpca[,2]*rev[4],pch=16,cex=0.3)
     points(o.pcovar$canpco[,1],o.pcovar$canpco[,2]*rev[4],pch=1,cex=0.8)
     abline(h=0,v=0,lwd=0.6,col="gray")
...
# bray
     ...
     points(o.pcovar$bpca[,1],o.pcovar$bpca[,2]*rev[5],pch=16,cex=0.3)
     points(o.pcovar$bpco[,1],o.pcovar$bpco[,2]*rev[5],pch=1,cex=0.8)
     abline(h=0,v=0,lwd=0.6,col="gray")
...
# correlation as distance
     ...
     points(o.pcovar$corpca[,1],o.pcovar$corpca[,2]*rev[6],pch=16,cex=0.3)
     points(o.pcovar$corpco[,1],o.pcovar$corpco[,2]*rev[6],pch=1,cex=0.8)
     abline(h=0,v=0,lwd=0.6,col="gray")
